                    ...
                    <div class="items-center flex flex-wrap">
                        <div class="w-full  px-4 ml-auto mr-auto text-center">
                            <div class="flex justify-center items-center flex-wrap w-full">
                                <h1 class="font-semibold text-4xl text-[#fec55a]">
                                    Fundación Amiga No Estás Sola
                                </h1>
                                <!-- <h2 class="text-4xl font-semibold text-center text-[#482c74]">Historia</h2> -->
                                <p class="text-xl leading-relaxed m-4 text-slate-200 font-semibold text-pretty w-full">
                                ...
                                <p class="text-xl leading-relaxed m-4 text-slate-200 font-semibold text-pretty">
                                ...
                                <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                                    <div class="px-6">
                                        <img alt="..." :src="erika" class="shadow-lg rounded-full mx-auto max-w-120-px" />
                                        <div class="pt-6 text-center">
                                            <h5 class="text-xl font-bold text-[#fec55a]">Erika Caro</h5>
                                            <p class="mt-1 text-sm text-slate-200 uppercase font-semibold">
                    ...
                    <div class="flex flex-wrap justify-center">
                        <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                            <div class="px-6">
                                <img alt="..." :src="erika" class="shadow-lg rounded-full mx-auto max-w-120-px" />
                                <div class="pt-6 text-center">
                                    <h5 class="text-xl font-bold">Erika Caro</h5>
                                    <p class="mt-1 text-sm text-slate-400 uppercase font-semibold">
                                        Psicologa y Fundadora
                                    </p>
                                    <div class="mt-6">
                                        <button
                                            class="bg-rose-500 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1"
...
import erika from "../assets/img/erika.png";
